...
## 실제 동기화 흐름
실제 노선 동기화는 [`prisma/seed.ts`](/Volumes/Backup/Github/NaSum-Church-Shuttle/prisma/seed.ts)와 [`lib/googleRouteSync.ts`](/Volumes/Backup/Github/NaSum-Church-Shuttle/lib/googleRouteSync.ts)가 담당한다.
...
## 지도에 표시되는 정보
현재 지도 렌더링은 [`components/Maps.tsx`](/Volumes/Backup/Github/NaSum-Church-Shuttle/components/Maps.tsx)와 [`lib/routeSelectors.ts`](/Volumes/Backup/Github/NaSum-Church-Shuttle/lib/routeSelectors.ts)를 기준으로 동작한다.
...
- [`lib/googleRouteSync.ts`](/Volumes/Backup/Github/NaSum-Church-Shuttle/lib/googleRouteSync.ts)
- [`lib/routeSelectors.ts`](/Volumes/Backup/Github/NaSum-Church-Shuttle/lib/routeSelectors.ts)
- [`components/Maps.tsx`](/Volumes/Backup/Github/NaSum-Church-Shuttle/components/Maps.tsx)
